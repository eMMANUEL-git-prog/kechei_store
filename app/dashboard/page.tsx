        ...
        {loading ? (
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="border-blue-500/20 bg-blue-500/5">
              <CardHeader className="flex flex-row items-center justify-between pb-2">
                <CardTitle className="text-sm font-medium">Goods Received</CardTitle>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <Card className="border-dashed cursor-pointer hover:bg-accent transition-colors">
                <CardHeader>
                  ...
                  <CardDescription>Browse all items and stock levels</CardDescription>
                </CardHeader>
              </Card>
              <Card className="border-dashed cursor-pointer hover:bg-accent transition-colors">
                <CardHeader>
                  <CardTitle className="text-base">Receive Stock</CardTitle>
                  <CardDescription>Create a new Goods Received Note</CardDescription>
                </CardHeader>
              </Card>
              <Card className="border-dashed cursor-pointer hover:bg-accent transition-colors">
                <CardHeader>
