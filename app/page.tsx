    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 p-4">
      <Card className="w-full max-w-md border-slate-800">
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            <CardTitle className="text-2xl font-bold">Store Inventory System</CardTitle>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="pt-4 border-t border-slate-800">
              ...
              <div className="space-y-1 text-xs text-slate-500">
                <p>
                  Admin: <span className="text-slate-300">admin / admin123</span>
                </p>
                <p>
                  Storekeeper: <span className="text-slate-300">storekeeper / admin123</span>
                </p>
              </div>
            </div>
          </form>
